...
const dataReducer=(state, action,)=>{
    switch (action.type) {
        ...
        case types.searchByDates:
            return{
                ...state,
                urlProducts : `/products/?checkIn=${action.payload.startDate}&checkOut=${action.payload.endDate}`,
        ...
        case types.searchByDatesAndCity:
            return{
                ...state,
                urlProducts : `/products/?checkIn=${action.payload.startDate}&checkOut=${action.payload.endDate}&name=${action.payload.city}`,
                //urlProducts : `hola`,
                selectedDays: action.payload,
                //city: action.payload,
                category: "",                 
